...
export default function Home() {
	return (
		<section className="flex flex-row gap-6 items-center min-h-full">
			...
			>
				<div className="flex flex-col flex-1 gap-10 bg-clip-text 
				...
				<Link
					href={"/"}
					className="inline-block w-fit border-2 py-2 px-4 rounded-lg border-orange-700 hover:rounded-2xl hover:border-emerald-800 inherit"
				>
					Resume
				</Link>
			</article>
